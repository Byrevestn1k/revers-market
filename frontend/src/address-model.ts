...
export type ListingMapLocationMode = 'profile' | 'pin' | 'address' | 'approximate'
export type AddressValue = { address: string; city: string; coordinates: Coordinates | null; settlement?: SelectedSettlement | null; addressVisibility?: AddressVisibility; addressVisibilityConsent?: boolean; mapLocationMode?: ListingMapLocationMode }
