...
У каркасі реалізовано реєстрацію, автентифікацію та базові профілі користувачів. Товари, карти, чат, замовлення та повна система відгуків ще не реалізовані.
